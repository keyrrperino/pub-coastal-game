...
const pillBase =
  'font-bold text-[28px] rounded-full w-14 h-14 flex items-center justify-center mx-2 shadow cursor-pointer transition';
const pillSelected = 'bg-[#cdcdfc] text-[#1B1B6B]';
const pillUnselected = 'bg-[#1B1B6B] text-white';

const buttonBase =
  'bg-[#4B2992] text-white font-bold text-[24px] rounded-[20px] py-2 px-8 ml-3 shadow hover:bg-[#3a2173] transition cursor-pointer';
const smallButtonBase =
  'bg-[#4B2992] text-white font-bold text-[22px] rounded-[20px] py-2 px-8 shadow hover:bg-[#3a2173] transition cursor-pointer';
  ...
  return (
    <div className="flex flex-row">
      <div className="flex-1">
        {/* Seawall */}
        <div className="bg-[#8EC3E6] rounded-[40px] py-6 px-8 mb-6 flex items-center">
          <span className="font-bold text-[32px] text-white tracking-wider mr-6 flex items-center">
        ...
        {/* Revetment */}
        <div className="bg-[#8EC3E6] rounded-[40px] py-6 px-8 mb-6 flex items-center">
          <span className="font-bold text-[32px] text-white tracking-wider mr-6 flex items-center">REVETMENT</span>
          {[10, 20].map((val) => (
            <span
              key={val}
              className={
      ...
      <div className="flex flex-row gap-6 ml-8">
        {/* Plant Mangroves */}
        <div className="bg-[#8EC3E6] rounded-[32px] py-4 px-8 mb-3 flex flex-col items-center">
          <span className="font-bold text-[28px] text-white tracking-wider mb-2">PLANT MANGROVES</span>
        ...
        <div>
          {/* Reclaim Area */}
          <div className="bg-[#8EC3E6] rounded-[32px] py-4 px-8 mb-3 flex flex-col items-center">
            <span className="font-bold text-[28px] text-white tracking-wider mb-2">RECLAIM AREA</span>
            <div className="flex gap-4 flex-col">
          ...
          {/* Build Earth Bunds */}
          <div className="bg-[#8EC3E6] rounded-[32px] py-2 px-6 min-w-0 flex flex-col items-center">
