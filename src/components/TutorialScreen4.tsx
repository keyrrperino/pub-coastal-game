...
export default function TutorialScreen3({ phaseStartTime, timeRemaining }: TutorialScreen3Props) {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-10 flex flex-col gap-15 items-center justify-center h-full px-8 pt-[2vh]">
        <div className="px-12 max-w-[89%] w-full">
          <div className="flex flex-col items-center gap-16 uppercase">
            {/* Top Section - Instructional Text */}
            <div className="flex flex-col gap-6 text-center">
              <p className="text-[#FFDD3D] text-[2vw] font-bold">
                Once you select your coastal protection, it is locked in for the round.
              </p>
              <p className="text-white text-[2vw] font-bold">
