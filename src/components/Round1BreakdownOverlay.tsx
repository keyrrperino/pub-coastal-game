  ...
  return (
    ...
    >
      ...
      <div className="relative w-[90vw] max-w-[600px] h-[90vh] max-h-[800px] scale-90">
        ...
        <div className="absolute top-[29px] left-[26px] w-full h-full bg-[#8491C6] rounded-[22px]" />
        ...
        <div className="absolute inset-0 flex flex-col rounded-[22px] overflow-hidden">
          ...
          <div className="flex-1 bg-white px-14 py-8">
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 mx-3 border-b border-dotted border-[#2A81FA] border-[1.68px]" />
                <span className="text-[#202020] text-[clamp(16px,2.5vw,31px)] font-bold font-condensed">
                  10,000
                </span>
              </div>
          ...
          <div className="bg-[#2A81FA] px-8 py-6">
            <div className="text-center">
              ...
              <div className="text-[clamp(40px,8vw,68px)] font-bold text-white">
                9,400
              </div>
            </div>
          </div>
