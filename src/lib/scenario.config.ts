...
export const optionalScenarioConfiguration: ScenarioConfigurationType = {
  ...
  [`1_1B_${ActivityTypeEnum.R1_1B_UPGRADE_MANGROVES_BOARDWALK}-None-1.15-1`]: { score: 50, coin: 0, cutscene: CutScenesEnum.R2_1B_8 },
  [`1_1B_${ActivityTypeEnum.R1_1B_UPGRADE_MANGROVES_BOARDWALK}-None-1.15-2`]: { score: 50, coin: 0, cutscene: CutScenesEnum.R2_1B_8 },
