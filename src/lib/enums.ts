...
export enum ActivityTypeEnum {
  ...
  R1_1A_UPGRADE_LR_TO_SEAWALL_1_15 = "r1 1a lr-sw 1.15",
  R1_1A_UPGRADE_LR_TO_SEAWALL_2 = "r1 1a lr-sw 2",

  // R1 1B / UPGRADE LAND RECLAMATION TO SEAWALL
  R1_1B_UPGRADE_LR_TO_SEAWALL_1_15 = "r1 1b lr-sw 1.15",
  R1_1B_UPGRADE_LR_TO_SEAWALL_2 = "r1 1b lr-sw 2",
